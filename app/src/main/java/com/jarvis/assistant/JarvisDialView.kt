...
class JarvisDialView @JvmOverloads constructor(
    ...
    private fun drawHolographicRings(
        canvas: Canvas,
        cx: Float,
        cy: Float,
        base: Float
        ...
        rings.forEachIndexed { index, ring ->
            ...
            val rotation =
                elapsed * (18f + index * 5f) * direction

            canvas.save()

            canvas.translate(
                0f,
                -sin(elapsed * 0.65f + index) * 10f
            )

            canvas.rotate(
                Math.toDegrees(tilt.toDouble()).toFloat(),
                cx,
                cy
            )
            ...
            ringPaint.strokeWidth =
                if (index % 2 == 0) 2.0f else 1.2f

            ringPaint.alpha =
                if (index % 2 == 0) 145 else 90

            ringPaint.color =
                if (index % 2 == 0) cyan else cyanSoft
